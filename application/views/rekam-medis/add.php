<div class="row">
    <div class="col-md-6">
        <div class="card card-outline card-success">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <?= form_open('', '', ['idRekamMedis' => $idRekamMedis, 'userId' => userdata('idUser')]); ?>
                ...
                <div class="form-group">
                    ...
                    <input value="<?= set_value('tglPeriksa', date('Y-m-d')); ?>" type="text" name="tglPeriksa" id="tglPeriksa" class="form-control gijgo" placeholder="Tanggal Periksa">
